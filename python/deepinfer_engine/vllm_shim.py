...
try:
    from deepinfer_engine.generated import engine_service_pb2, engine_service_pb2_grpc
except ImportError:
...
class VLLMEngineServicer:
    ...
    async def initialize(self):
        ...
        try:
            ...
            # Configure ModelScope for Chinese users
            import os
...
async def serve_vllm(args):
    ...
    if engine_service_pb2 is None or engine_service_pb2_grpc is None:
        ...
        logger.error("python -m grpc_tools.protoc -I protos --python_out=python/deepinfer_engine/generated --grpc_python_out=python/deepinfer_engine/generated protos/engine_service.proto")
        return
